...
const Footer = () => {
  return (
    <div className="flex lg:flex-row md:flex-col flex-col space-y-2 items-center justify-between px-2 md:px-4 lg:px-8 pb-2 mt-5">
      <h6 className="text-[#4B4CFF] text-[2.5vw] md:text-[1.5vw] lg:text-[1.2vw] xl:text-[.9vw]">
      ...
      <div className="text-[#4B4CFF] font-semibold space-x-4 md:space-x-2 lg:space-x-4 text-[2.5vw] md:text-[1.5vw] lg:text-[1.2vw] xl:text-[.9vw]">
        <a href="">
          Language: &nbsp;
        ...
        <a href="">
          Country:&nbsp;
          <span className="text-white font-thin lg:font-normal">UAE</span>
        </a>
