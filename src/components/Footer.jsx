...
const Footer = () => {
  return (
    <div className="flex flex-col space-y-2 md:flex-row items-center text-[7px] md:text-[10px]   font-thin lg:font-normal lg:text-sm justify-between mx-2 md:mx-4 lg:mx-8 mb-4">
      <div>
        <h1 className="text-[#4B4CFF]">
      ...
      <div className="text-[#4B4CFF] font-semibold space-x-4  md:space-x-2 lg:space-x-4">
        <a href="">
          Language:{" "}
          <span className="text-white text-[6px] md:text-[10px]  font-thin lg:font-normal lg:text-sm">
            English
          </span>{" "}
        </a>
        <a href="">
